...
import (
	...
	"github.com/TicketsBot-cloud/common/reopenrelay"
...
func ListenTicketReopen() {
	ch := make(chan reopenrelay.TicketReopen)
	go reopenrelay.Listen(redis.Client, ch)
	...
	for payload := range ch {
		...
		go func() {
			...
			logic.ReopenTicket(ctx, &cc, payload.TicketId)
		}()
	}
}
