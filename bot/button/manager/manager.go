...
func (m *ComponentInteractionManager) RegisterCommands() {
	m.buttonRegistry = append(m.buttonRegistry,
		...
		new(handlers.GDPRExportGuildHandler),
		new(handlers.GDPRExportUserHandler),
		new(handlers.GDPRConfirmExportGuildHandler),
		new(handlers.GDPRConfirmExportUserHandler),
