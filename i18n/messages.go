...
var (
	...
	PermissionsReadMessages           MessageId = "commands.permissions.decreption.read_messages"
	PermissionsSendMessages           MessageId = "commands.permissions.decreption.send_messages"
	PermissionsEmbedLinks             MessageId = "commands.permissions.decreption.embed_links"
	PermissionsAttachFiles            MessageId = "commands.permissions.decreption.attach_files"
	PermissionsAddReactions           MessageId = "commands.permissions.decreption.add_reactions"
	PermissionsUseExternalEmojis      MessageId = "commands.permissions.decreption.use_external_emojis"
	PermissionsMentionEveryone        MessageId = "commands.permissions.decreption.mention_everyone"
	PermissionsReadMessageHistory     MessageId = "commands.permissions.decreption.read_message_history"
	PermissionsManageChannels         MessageId = "commands.permissions.decreption.manage_channels"
	PermissionsManageRoles            MessageId = "commands.permissions.decreption.manage_roles"
	PermissionsManageWebhooks         MessageId = "commands.permissions.decreption.manage_webhooks"
	PermissionsManageThreads          MessageId = "commands.permissions.decreption.manage_threads"
	PermissionsSendMessagesInThreads  MessageId = "commands.permissions.decreption.send_messages_in_threads"
	PermissionsCreatePublicThreads    MessageId = "commands.permissions.decreption.create_public_threads"
	PermissionsCreatePrivateThreads   MessageId = "commands.permissions.decreption.create_private_threads"
	PermissionsUseApplicationCommands MessageId = "commands.permissions.decreption.use_application_commands"
