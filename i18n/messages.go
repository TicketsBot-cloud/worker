...
var (
	...
	PermissionsSendMessages           MessageId = "commands.permissions.use.send_messages"
	PermissionsEmbedLinks             MessageId = "commands.permissions.use.embed_links"
	PermissionsAttachFiles            MessageId = "commands.permissions.use.attach_files"
	PermissionsAddReactions           MessageId = "commands.permissions.use.add_reactions"
	PermissionsUseExternalEmojis      MessageId = "commands.permissions.use.use_external_emojis"
	PermissionsMentionEveryone        MessageId = "commands.permissions.use.mention_everyone"
	PermissionsReadMessageHistory     MessageId = "commands.permissions.use.read_message_history"
	...
	PermissionsManageThreads          MessageId = "commands.permissions.use.manage_threads"
	PermissionsSendMessagesInThreads  MessageId = "commands.permissions.use.send_messages_in_threads"
	PermissionsCreatePublicThreads    MessageId = "commands.permissions.use.create_public_threads"
	PermissionsCreatePrivateThreads   MessageId = "commands.permissions.use.create_private_threads"
	PermissionsUseApplicationCommands MessageId = "commands.permissions.use.use_application_commands"
